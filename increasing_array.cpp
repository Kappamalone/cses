...
int main()
{
  ...
  // this question is simple, but highlights how greedy solutions work by 
  // taking the minimal difference between curr and prev, since any greater difference
  // could be swapped for the minimal difference, be a valid solution and reduce the 
  // number of moves
